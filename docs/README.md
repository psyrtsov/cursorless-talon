...
| ----------- | ------------ | ------------------------------------------------------------------------------------------------------------------------------ | ------------------- |
| `"ex"`      | `ex`         | ![Ex](https://raw.githubusercontent.com/pokey/cursorless-vscode/tweak-svg-readme-display-5/images/hats/ex.svg)                 | ❌                  |
| `"fox"`     | `fox`        | ![Fox](https://raw.githubusercontent.com/pokey/cursorless-vscode/tweak-svg-readme-display-5/images/hats/fox.svg)               | ❌                  |
| `"wing"`    | `wing`       | ![Wing](https://raw.githubusercontent.com/pokey/cursorless-vscode/tweak-svg-readme-display-5/images/hats/wing.svg)             | ❌                  |
| `"hole"`    | `hole`       | ![Hole](https://raw.githubusercontent.com/pokey/cursorless-vscode/tweak-svg-readme-display-5/images/hats/hole.svg)             | ❌                  |
| `"frame"`   | `frame`      | ![Frame](https://raw.githubusercontent.com/pokey/cursorless-vscode/tweak-svg-readme-display-5/images/hats/frame.svg)           | ❌                  |
| `"curve"`   | `curve`      | ![Curve](https://raw.githubusercontent.com/pokey/cursorless-vscode/tweak-svg-readme-display-5/images/hats/curve.svg)           | ❌                  |
| `"eye"`     | `eye`        | ![Eye](https://raw.githubusercontent.com/pokey/cursorless-vscode/tweak-svg-readme-display-5/images/hats/eye.svg)               | ❌                  |
| `"play"`    | `play`       | ![Play](https://raw.githubusercontent.com/pokey/cursorless-vscode/tweak-svg-readme-display-5/images/hats/play.svg)             | ❌                  |
| `"cross"`   | `crosshairs` | ![Crosshairs](https://raw.githubusercontent.com/pokey/cursorless-vscode/tweak-svg-readme-display-5/images/hats/crosshairs.svg) | ❌                  |
| `"bolt"`    | `bolt`       | ![Bolt](https://raw.githubusercontent.com/pokey/cursorless-vscode/tweak-svg-readme-display-5/images/hats/bolt.svg)             | ❌                  |
